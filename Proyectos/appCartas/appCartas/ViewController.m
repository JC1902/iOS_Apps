...
- (IBAction)touchCardButton:(UIButton *)sender {
    ...
    if ( self.game.score <= -40 ) {
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Perdiste 😭" message:@"Mejor suerte para la otra" preferredStyle:UIAlertControllerStyleAlert];
        
        UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault 
                                                         handler: ^(UIAlertAction * _Nonull ) {
            exit(0);
        }];
